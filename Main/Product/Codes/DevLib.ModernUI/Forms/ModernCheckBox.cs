//-----------------------------------------------------------------------
// <copyright file="ModernCheckBox.cs" company="YuGuan Corporation">
...
namespace DevLib.ModernUI.Forms
{
    ...
    /// <summary>
    /// ModernCheckBox user control.
    /// </summary>
    [ToolboxBitmap(typeof(CheckBox))]
    public class ModernCheckBox : CheckBox, IModernControl
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ModernCheckBox" /> class.
        /// </summary>
        ...
        protected virtual void OnPaintForeground(PaintEventArgs e)
        {
            ...
            if (this.Checked)
            {
                Color fillColor = this.CheckState == CheckState.Indeterminate ? borderColor : ModernPaint.GetStyleColor(this.ColorStyle);

                using (SolidBrush brush = new SolidBrush(fillColor))
                {
                    Rectangle boxRectangle = new Rectangle(2, (Height / 2) - 4, 9, 9);
