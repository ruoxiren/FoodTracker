//-----------------------------------------------------------------------
// <copyright file="WebServiceClientObject.cs" company="YuGuan Corporation">
...
namespace DevLib.Web.Services
{
    ...
    /// </summary>
    [Serializable]
    public class WebServiceClientObject : MarshalByRefObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WebServiceClientObject" /> class.
        /// </summary>
        /// <param name="obj">The object to use.</param>
        public WebServiceClientObject(object obj)
        {
            if (obj == null)
            {
        ...
        public WebServiceClientObject(Type objectType)
        {
            if (objectType == null)
            {
        ...
        public void CallConstructor(Type[] paramTypes, object[] paramValues)
        {
            ...
            if (ctor == null)
            {
                throw new ArgumentException(WebServiceClientProxyConstants.ProxyCtorNotFound, "paramTypes");
            }
        ...
        public virtual object CallMethod(string methodName, Type[] types, object[] parameters)
        {
            ...
            {
                throw new ArgumentException(WebServiceClientProxyConstants.ParameterValueMismatch);
            }
            ...
            if (methodInfo == null)
            {
                throw new ArgumentException(string.Format(WebServiceClientProxyConstants.MethodNotFoundStringFormat, methodName), "methodName");
            }
