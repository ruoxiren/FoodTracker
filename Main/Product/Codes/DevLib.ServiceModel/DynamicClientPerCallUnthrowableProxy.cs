//-----------------------------------------------------------------------
// <copyright file="DynamicClientPerCallUnthrowableProxy.cs" company="YuGuan Corporation">
...
namespace DevLib.ServiceModel
{
    ...
    /// <summary>
    /// DynamicClientPerCallUnthrowableProxy class.
    /// </summary>
    public class DynamicClientPerCallUnthrowableProxy : DynamicClientProxyBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DynamicClientPerCallUnthrowableProxy"/> class.
        /// </summary>
        /// <param name="proxyType">Type of the proxy.</param>
        /// <param name="binding">The binding.</param>
        /// <param name="remoteUri">The remote URI.</param>
        public DynamicClientPerCallUnthrowableProxy(Type proxyType, Binding binding, string remoteUri)
        ...
        /// <param name="remoteUri">The remote URI.</param>
        public DynamicClientPerCallUnthrowableProxy(Type proxyType, Type bindingType, string remoteUri)
